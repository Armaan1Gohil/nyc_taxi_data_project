...
# Install Hadoop AWS package for S3A support (MinIO) and Nessie dependencies
RUN apt-get update && \
    ...
    wget https://repo1.maven.org/maven2/org/apache/iceberg/iceberg-nessie/1.5.2/iceberg-nessie-1.5.2.jar -P /opt/spark/jars/ && \
    wget https://repo.maven.apache.org/maven2/org/projectnessie/nessie-integrations/nessie-spark-extensions-3.4_2.12/0.99.0/nessie-spark-extensions-3.4_2.12-0.99.0.jar -P /opt/spark/jars/ && \
    wget https://github.com/projectnessie/nessie/releases/download/nessie-0.99.0/nessie-quarkus-0.99.0-runner.jar -P /opt/spark/jars/ && \
